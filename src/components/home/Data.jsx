...
const Data = () => {
  return (
      <div className="home__data">
          <h1 className="home__title">Олександра Кривонос
          <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
          ...
          <h3 className="home__subtitle">Дипломований Психолог</h3>
          <p className="home__description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur necessitatibus fugit consequuntur fuga non ipsa dignissimos magni vel!</p>

          <a href="#contact" className="button button--flex">Записатися
          <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
